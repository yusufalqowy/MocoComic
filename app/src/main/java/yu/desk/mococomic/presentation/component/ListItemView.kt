...
class ListItemView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : MaterialCardView(context, attrs, defStyleAttr) {
    ...
    private val selectedContainerColor = MaterialColors.getColor(context, com.google.android.material.R.attr.colorSecondaryContainer, context.getColor(com.google.android.material.R.color.design_default_color_secondary))
    private val defaultIconColor = MaterialColors.getColor(context, com.google.android.material.R.attr.colorOnSurfaceVariant, binding.ivLeadingIcon.solidColor)
    private val selectedIconColor = MaterialColors.getColor(context, com.google.android.material.R.attr.colorPrimary, context.getColor(com.google.android.material.R.color.design_default_color_primary))
    private val defaultTextColor = MaterialColors.getColor(context, com.google.android.material.R.attr.colorOnSurface, binding.tvLabel.currentTextColor)
    private val selectedTextColor = MaterialColors.getColor(context, com.google.android.material.R.attr.colorOnSecondaryContainer, binding.tvLabel.currentTextColor)
