package yu.desk.mococomic.presentation.termscondition
...
class TermsAndConditionsFragment : Fragment() {
	...
	private fun initView() {
		binding.apply {
			...
			toolbar.title = getString(R.string.text_terms_conditions)

			webView.loadData(MyConstants.HTML_TERMS_CONDITIONS, "text/html", "UTF-8")
		}
	}
}