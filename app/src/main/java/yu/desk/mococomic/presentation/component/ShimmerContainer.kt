...
class ShimmerContainer
	...
	constructor(
		...
		private var shimmerMarginStart: Int = 0
		private var shimmerMarginEnd: Int = 0
		private var shimmerMarginTop: Int = 0
		private var shimmerMarginBottom: Int = 0
		...
		init {
			...
			try {
				...
				shimmerMarginStart =
					typedArray.getDimensionPixelSize(R.styleable.ShimmerContainer_shimmerMarginStart, 0)
				shimmerMarginEnd = typedArray.getDimensionPixelSize(R.styleable.ShimmerContainer_shimmerMarginEnd, 0)
				shimmerMarginTop = typedArray.getDimensionPixelSize(R.styleable.ShimmerContainer_shimmerMarginTop, 0)
				shimmerMarginBottom =
					typedArray.getDimensionPixelSize(R.styleable.ShimmerContainer_shimmerMarginBottom, 0)
			} finally {
				typedArray.recycle()
			}
			initView()
		...
		private fun initView() {
			...
			binding.shimmerLayout.updateLayoutParams<MarginLayoutParams> {
				this.leftMargin = shimmerMarginStart
				this.rightMargin = shimmerMarginEnd
				this.topMargin = shimmerMarginTop
				this.bottomMargin = shimmerMarginBottom
			...
			val totalWidth =
				(
					if (shimmerWidth ==
						...
						measuredWidth.minus(shimmerMarginStart + shimmerMarginEnd)
					} else {
						shimmerWidth
					}
